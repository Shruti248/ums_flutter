...
// Creating teh login controlller & placing the login function inside it
...
// Modify your stateless widget to use the controller:
        ...
        child: Form(
            ...
            child:Column(
              children: <Widget>[
                ...
                // email
                TextFormField(
                  controller: loginController._emailController,
                  validator: (String? email){
                    if(email == null || email.isEmpty){
                      return "Required";
                    }
                ...
                // password
                TextFormField(
                  controller: loginController._passwordController,
                  validator: (String? password){
                    if(password == null || password.isEmpty){
                      return "Required";
                    }
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    if (loginController._emailController.text.isNotEmpty && loginController._passwordController.text.isNotEmpty) {

                      // Call userRegistration method with form data
                      try {
                        Map<String, dynamic> res = await loginController.userLogin(
                          email: loginController._emailController.text,
                          password: loginController._passwordController.text,
                        );
                        ...
                        // Converting the same Snackbar using getX
                        // now only this part will reload & not the entire screen
                        // So we made a part f teh screen stateful & all teh other components continue to remain stateless
